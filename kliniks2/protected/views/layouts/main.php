	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Pembayaran Tagihan', 'url'=>array('/PembayaranTagihan/index')),
				array('label'=>'Peran', 'url'=>array('/Peran/index')),
				array('label'=>'Obat', 'url'=>array('/Obat/index')),
				array('label'=>'Transaksi Tindakan Obat', 'url'=>array('/TransaksiTindakanObat/index')),
